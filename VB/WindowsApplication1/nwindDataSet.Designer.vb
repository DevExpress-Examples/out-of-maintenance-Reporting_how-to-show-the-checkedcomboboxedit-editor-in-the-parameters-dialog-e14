...
Namespace WindowsApplication1.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		<System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, True)>
		Public Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_CategoryID? As Integer, ByVal Original_QuantityPerUnit As String, ByVal Original_UnitPrice? As Decimal, ByVal Original_UnitsInStock? As Short) As Integer
			...
			If (Original_UnitsInStock.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(10).Value = (CShort(Original_UnitsInStock.Value))
			Else
		...
		<System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
		Public Overridable Function Update(ByVal ProductName As String, ByVal CategoryID? As Integer, ByVal QuantityPerUnit As String, ByVal UnitPrice? As Decimal, ByVal UnitsInStock? As Short, ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_CategoryID? As Integer, ByVal Original_QuantityPerUnit As String, ByVal Original_UnitPrice? As Decimal, ByVal Original_UnitsInStock? As Short) As Integer
			...
			If (UnitsInStock.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CShort(UnitsInStock.Value))
			Else
			...
			If (Original_CategoryID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CInt(Original_CategoryID.Value))
			Else
			...
			If (Original_UnitsInStock.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(15).Value = (CShort(Original_UnitsInStock.Value))
			Else
